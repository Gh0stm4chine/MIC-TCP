...
// Variables globales
struct mic_tcp_sock local_sock;
struct mic_tcp_sock_addr dist_sock_addr;
struct mic_tcp_pdu DT;
int PE,PA;
int timer;
char *window;
int connexion;
...
{
  CLOSED, SYN_SENT,ATTENTE_SYN,SYN_ACK_SENT, SYN_ACK_RECEIVED,SYN_RECEIVED,ACK_RECEIVED,CONNECTED, ESTABLISHED, CLOISING,ATTENTE_ACK,ATTENTE_SEND,FIN_ACK_SENT,SEND_ACK,FIN_ACK_RECEIVED,FIN_SENT,SEND_FIN_ACK
} protocol_state;
